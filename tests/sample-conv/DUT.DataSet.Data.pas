...
type
  TDUTDataSetData = class(TDataModule)
    SQLTable1: TSQLTable;
...
var
  DUTDataSetData: TDUTDataSetData;
...
procedure TDUTDataSetData.Open(AIdx: integer);
var
  dts: TDataSet;
begin
  ...
  case AIdx of
    ...
    3: // TSimpleDataSet
    begin
      SimpleDataSet1.Connection := SQLQuery1.SQLConnection; // Fix connection problem
